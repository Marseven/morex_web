        ...
        <div class="w-full max-w-md relative z-[1] animate-fade-up">
            ...
            <div class="glass-card p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        <label for="name" class="block text-xs font-medium text-theme-text-secondary uppercase tracking-wider mb-2">
                            Nom
                        </label>
                        <input
                            id="name"
                            ...
                            required
                            autofocus
                            class="w-full bg-theme-surface/50 border border-theme-border rounded-lg px-4 py-3 text-theme-text-primary placeholder-theme-text-muted input-glow focus:ring-0 outline-none transition-all duration-200"
                ...
                <div class="mt-6 text-center">
                    <p class="text-theme-text-secondary text-sm">
                        Déjà un compte ?
                        <Link href="/login" class="text-[var(--color-accent)] hover:underline font-medium">
                            Se connecter
                        </Link>
                    </p>
                </div>
